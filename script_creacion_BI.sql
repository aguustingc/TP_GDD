...
TIEMPO_ANIO INTEGER NOT NULL,
TIEMPO_MES INTEGER NOT NULL);
...
COMPRA_FABRICANTE INT NOT NULL FOREIGN KEY REFERENCES SPARK.BI_DIM_FABRICANTE(FABRICANTE_ID),
...
-- BI_DIM_TIEMPO (SE CREA LA BI_DIM_ENSION MEDIANTE UN STORED PROCEDURE PARA AUTOMATIZAR EL INSERT DE FECHAS ANIO Y MES)

EXEC SPARK.CrearDimTiempo 1900, 2025
...
-- BI_FACT_COMPRA (FALTA EL INSERT)

-- BI_FACT_VENTA (FALTA EL INSERT)
