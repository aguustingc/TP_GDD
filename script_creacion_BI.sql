...
IF OBJECT_ID('SPARK.BI_VW_TRANSACCIONES','V') IS NOT NULL
  DROP VIEW SPARK.BI_VW_TRANSACCIONES;
...
VENTA_TIPO_CLIENTE INT NOT NULL FOREIGN KEY REFERENCES SPARK.BI_DIM_CLIENTE(CLIENTE_ID),
...
SELECT prod.PRODUCTO_ID AS PRODUCTO, suc.SUCURSAL_ID AS SUCURSAL, clib.CLIENTE_ID AS CLIENTE, ti.TIEMPO_ID, dfac.DETALLE_NUMERO AS NUMERO_VENTA, dfac.DETALLE_CANTIDAD AS CANTIDAD, prod.PRODUCTO_PRECIO AS PRECIO, (dfac.DETALLE_CANTIDAD*prod.PRODUCTO_PRECIO) AS IMPORTE
